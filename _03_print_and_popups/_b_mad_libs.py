...
if __name__ == '__main__':
    ...
    simpledialog.askstring(title='Mad Limbs', prompt="If you find yourself having to cross a piranha-infested river, here's how to do it...")
    # Get the player to enter an adjective
    a = simpledialog.askstring(title='Mad Limbs', prompt="Enter an adjective")
    # Get the player to enter a type of liquid
    b = simpledialog.askstring(title='Mad Limbs', prompt="Enter a kind of liquid")
    # Get the player to enter a body part
    c = simpledialog.askstring(title='Mad Limbs', prompt="Enter a name of a limb")
    # Get the player to enter a verb
    d = simpledialog.askstring(title='Mad Limbs', prompt="Type a verb")
    # Get the player to enter a place
    e = simpledialog.askstring(title='Mad Limbs', prompt="Type a place (e.g. building, city, habitat)")
    ...
    simpledialog.askstring(title='Mad Limbs', prompt="Piranhas are more " + a + " during the day, so cross the river at\n"
        "night. Piranhas are attracted to fresh " + b + " and will most\n"
        "likely take a bite out of your " + c + " if you " + d + ". Whatever\n"
        "you do, if you have an open wound, try to find another way to get back to the " + e + ". Good luck!")
